...
function findAdults(persons) {
	...
	peoples.push(female);
	// log(peoples) = [[filtre femmes adulte]];
	peoples.push(
		persons.filter((person) => person.age >= 18 && person.sex === "male")
	);
	// log(peoples) = [[filtre femmes adulte], [filtre hommes adulte]];
